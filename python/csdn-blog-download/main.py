...
group.add_argument('--category_url', type=str,
                    help='CSDN Category Url, e.g., https://blog.csdn.net/<sp>/category_1234567.html')
group.add_argument('--article_url', type=str,
                    help='CSDN Article Url, e.g., https://blog.csdn.net/<sp>/article/details/123456789')
...
if __name__ == '__main__':
    ...
    if args.combine_together:
        ...
        md_file = 'my_together_file.md'  # 合并所有文档
